...
if __name__ == "__main__":
    try:
        ...
        all_text =  ["potato", "tomato", "apple", "chocolate", "fridge", "carrot", "banana", "cucumber", "lettuce", "onion"]
        ...
        collection = get_or_create_collection(client, collection_name, all_text, all_metadata, model)
